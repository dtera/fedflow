...
class SAPLlamaConfig(LlamaConfig):
    def __init__(
            self,
            vocab_size=32000,
            hidden_size=4096,
        ...
        self.rcd = rcd
        self.rdc = rdc
        self.vendor_ip = vendor_ip
        self.vendor_port = vendor_port
        self.layers_to_transform = layers_to_transform


class SAPLlamaAttention(LlamaAttention):
    """Multi-headed attention from 'Attention Is All You Need' paper"""

    def __init__(self, config: SAPLlamaConfig, add_lora: bool):
...
class PLLlamaDecoderLayer(LlamaDecoderLayer):
    def __init__(self, config: SAPLlamaConfig, add_lora: bool):
        ...
        self.self_attn = SAPLlamaAttention(config=config, add_lora=add_lora)
...
class SAPLlamaPreTrainedModel(PreTrainedModel):
    config_class = SAPLlamaConfig
...
class LlamaModel(SAPLlamaPreTrainedModel):
    """
    ...
    def __init__(self, config: SAPLlamaConfig):
        super().__init__(config)
...
class LlamaForVender(SAPLlamaPreTrainedModel):
...
class LlamaForCustomer(SAPLlamaPreTrainedModel):
    _tied_weights_keys = ["lm_head.weight"]
